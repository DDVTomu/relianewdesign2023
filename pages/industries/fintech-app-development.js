          ...
          <div className="industries-choose">
            ...
            <Animation className="industries-choose__content">
              <p>
                ...
                personal information very seriously. Accordingly, we take every
                reasonable measure and precaution possible to help our clients
                protect and secure the data that they process.
              </p>
              <h6>
                Below are a few examples of Fintech related technologies we work
                with:
              </h6>
        ...
        <Animation className="back-office">
          <div className="container">
            <h2 className="hdg-lv2">
              ...
              <br className="visible-pc" /> Flawless <span>Fintech</span> Mobile
              Apps
            </h2>
            <div className="back-office__row">
              ...
              <Animation className="back-office__col">
                ...
                <p>
                  We optimize the designs to ensure your Fintech mobile and web
                  applications a unique voice that distinguishes itself from
                  other Fintech solutions and instills your brand identity among
                  your users.
                </p>
              </Animation>
            </div>
        ...
        <div className="container">
          <div className="box-heavy">
            ...
            <div className="box-heavy__content">
              <Animation className="box-heavy__inner">
                <h2 className="hdg-lv2">
                  Stand Out With an Outstanding <span>Fintech Mobile App</span>
                </h2>
                <p>
                  A recent survey has revealed that mobile wallet adoption has
                  increased by 56 percent and mobile transactions by 53 percent.
                  Competing with the adoption speed, voice-based transactions
                  are also on the rise.
                </p>
                <p>
                  With us, simple yet unique designs, powerful and structured
                  programming, and reinforced security go hand-in-hand with the
                  latest technology upgrades and trending market customizations.
                </p>
              </Animation>
            </div>
          </div>
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__text">
              ...
              <p>
                Our team of experts leverage their profound Fintech Development
                expertise to create custom online stores, integrations and
                applications.
              </p>
              <p>
