...
const IndustriesPage = () => {
  const seo = {
    ...
    metaDescription:
      "Relia Software, Top Travel Mobile Application Development Company. We provide excellent travel app development services globally. Check out our projects!",
    shareImage: ogpImage,
    article: true,
  };
  return (
      ...
      <div className="main">
        <div className="container">
          <Image
            ...
            src="/images/industries/travel-app-development.jpg"
            width={626}
            height={626}
            layout="intrinsic"
            loading="eager"
          ...
          <div className="industries-choose">
            ...
            <Animation className="industries-choose__content">
              <p>
                ...
                development phase to build user-centric interfaces so as to give
                users a seamless and memorable experience.
              </p>
              <h6>
          ...
          <div className="box-media">
            <Animation className="box-media__img">
              <Image
                alt="Travel app developers"
                src="/images/industries/travel-app-developers.jpg"
                width={852}
                height={700}
                layout="intrinsic"
                loading="eager"
            ...
            <div className="back-office__row">
              ...
              <Animation className="back-office__col">
                ...
                <p>
                  ...
                  advanced technologies and integrate them into the applications
                  we build. We work with Blockchain, Artificial Intelligence,
                  AR, and VR, among other technologies.
                </p>
              </Animation>
            </div>
          </div>
        ...
        <div className="container">
          <div className="box-heavy">
            <Animation className="box-heavy__head">
              <h3>
                71% of Smartphone Users Who Use Their Phones for Travel Do So at
                Least Weekly
              </h3>
              <p>
            ...
            <div className="box-heavy__content">
              <Animation className="box-heavy__inner">
                ...
                <p>
                  The advent of smartphones and mobile applications has provided
                  businesses with a plethora of tools to promote themselves.
                </p>
                <p>
                  With Travel mobile app development, you can reach out to your
                  customers and market your services to increase the
                  conversions. In fact, 58% of travel apps are used at least
                  monthly. Your travel mobile app also allows your customers to
                  access your services 24x7, increasing brand loyalty, revenue,
                  and reputation.
                </p>
              </Animation>
            </div>
          ...
          <div className="box-media">
            <Animation className="box-media__text">
              ...
              <p>
                ...
                company. We also double our efforts to make the features of the
            ...
            <Animation className="box-media__img">
              <Image
                alt="Travel app development companies in vietnam"
                src="/images/industries/travel-app-development-companies-in-vietnam.jpg"
                width={626}
                height={352}
                layout="intrinsic"
                loading="eager"
          ...
          <div className="list-operations">
            <Animation className="list-operations__col">
              ...
              <ul className="list-plus">
                ...
                <li>
                  Realize the full benefits of a more complete and expansive RPA
                  opportunity
                </li>
              </ul>
            </Animation>
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__text">
              ...
              <p>
                Our team of experts leverage their profound
                Traveltravel-app-development Development expertise to create
                custom online stores, integrations and applications.
              </p>
              <p>
