          ...
          <div className="container">
            ...
            <div className="back-office__row">
              <Animation className="back-office__col">
                <Image alt="icon screen" src="/images/icon/icon-screen.svg" width={71} height={66} layout="intrinsic"loading="eager" />
              ...
              <Animation className="back-office__col">
                <Image alt="icon tap" src="/images/icon/icon-tap.svg" width={86} height={66} layout="intrinsic"loading="eager" />
              ...
              <Animation className="back-office__col">
                <Image alt="icon ai" src="/images/icon/icon-ai.svg" width={86} height={82} layout="intrinsic"loading="eager" />
        ...
        <div className="container">
          ...
          <div className="list-operations">
            <Animation className="list-operations__col">
              <Image alt="icon shield" src="/images/icon/icon-shield.svg" width={70} height={81} layout="intrinsic"loading="eager" />
              <h5>
            ...
            <Animation className="list-operations__col">
              <Image alt="icon loss" src="/images/icon/icon-loss.svg" width={55} height={85} layout="intrinsic"loading="eager" />
            ...
            <Animation className="list-operations__col">
              <Image alt="icon update" src="/images/icon/icon-update.svg" width={72} height={72} layout="intrinsic"loading="eager" />
          ...
          <div className="box-media">
            <Animation className="box-media__img">
              <Image alt="img note" src="/images/industries/img-note.png" width={535} height={355} layout="intrinsic"loading="eager" />
            </Animation>
            <Animation className="box-media__text">
              <h2 className="hdg-lv2">
