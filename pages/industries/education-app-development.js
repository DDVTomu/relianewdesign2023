...
const IndustriesPage = () => {
  const seo = {
    ...
    metaDescription:
      "Are you looking for Educational App Development? We provide custom education app development services for your business. Check out our Work now! Talk to us.",
    shareImage: ogpImage,
    article: true,
  };
  return (
        ...
        <div className="container">
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__text">
              <h2 className="hdg-lv2">
                <span>Our robots’</span> Deliver More Than Your Customers’ UI/UX
                Expectations with Quality Education App Development Solutions
              </h2>
              <p>
          ...
          <div className="container">
            ...
            <div className="back-office__row">
              <Animation className="back-office__col">
                ...
                <p>
                  Apps for education institutions we build are marked by simple
                  designs and relevant controls. And yet, we develop education
                  apps with a unique and rememberable feel making subtle changes
                  in the development.
                </p>
              </Animation>
              <Animation className="back-office__col">
                ...
                <p>
                  Your customers access your education platform to unlock faster
                  learning, and so course accessibility plays an important role.
                  With seamless navigation and evident controls, we guide your
                  customers to reach their courses and goals quickly.
                </p>
              </Animation>
              <Animation className="back-office__col">
                <Image
                ...
                <p>
                  ...
                  and deliver a pleasing experience to keep them coming back to
                  use your services.
                </p>
              </Animation>
            </div>
        ...
        <div className="container">
          <div className="box-heavy">
            <Animation className="box-heavy__head">
              <h3>
                The worldwide e-learning market is projected to reach the worth
            ...
            <div className="box-heavy__content">
              <Animation className="box-heavy__inner">
                ...
                <p>
                  With the help of our experienced education app developers, we
                  produce the best applications to assist in your business
                  endeavors.
                </p>
              </Animation>
            </div>
          ...
          <div className="box-heading">
            ...
            <Animation className="hdg-lv2-sub">
              Relia Software follows a well-defined, structural approach towards
              development. We analyze the market trends and arrive at the
              necessities before diving into development. We also ensure to
              follow the code standards throughout the development to make it
            ...
            <Animation className="box-media__text">
              <ul className="list-plus">
                <li>
                  ...
                  education applications are reinforced with fast and responsive
                  features that get your customers’ jobs done in a jiffy.
                </li>
                <li>
                ...
                <li>
                  Error-free Coding Enables Pleasurable User Experience The last
                  thing you want is an erred feature to make the customers feel
                  repulsed whenever they want to use your services.
                </li>
              </ul>
            </Animation>
            <Animation className="box-media__img">
          ...
          <div className="list-operations">
            <Animation className="list-operations__col">
              ...
              <p>
                Web searches are still one of the major ways people use to learn
                something..
              </p>
              <ul className="list-plus">
                <li>
                ...
                <li>
                  We Provide 24x7 Support and Maintenance We are your technical
                  hand of business and travel with you through thick and thin.
                  We have got you covered for upgrades, support, maintenance,
                  new product development, consulting, and every service.
                </li>
                <li>
                  Optimized for Search Engine optimization Every business should
                  be findable when searched for on the internet. However,
                  e-learning platforms take precedence above everything as it is
                  the only way of finding the service.
                </li>
              </ul>
            </Animation>
            <Animation className="list-operations__col">
              ...
              <ul className="list-plus">
                <li>
                  Quality Android Education App Development A sizable portion of
                  the world population, more than 80%, use Android smartphones,
                  and the only way to reach them is to build an android
                  application.
                </li>
                <li>
                  Standard IOS Education App Development IOS device users are
                  loyal to the brand and you don’t want to miss the opportunity
                  of converting such an audience into your customers with the
                  best education app development partner.
                </li>
                <li>
            ...
            <Animation className="list-operations__col">
              ...
              <p>
                Pour your dreams into our hands and we will give it back in the
                form applications.
              </p>
              <ul className="list-plus">
                <li>
                ...
                <li>
                  ...
                  keen eye on the future so that when the market changes and you
                  can add new elements to your app to engage your audience.
                </li>
                <li>
                  Integrated with Advanced Technologies As a company of
                  tech-savvy developers, we don’t just research to upgrade our
                  skills, we put that into practice and take app development to
                  the next level.
                </li>
              </ul>
            </Animation>
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__text">
              ...
              <p>
                We're always here to help you on your Relia journey, in any way
                we can.
              </p>
