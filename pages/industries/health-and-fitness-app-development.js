...
const IndustriesPage = () => {
  const seo = {
    metaTitle:
      "Health and Fitness App Development | Health and Fitness App Developers",
    metaDescription:
      "The increasing awareness of fitness and personal wellbeing has resulted in the unprecedented growth of fitness apps, increasing the demand for quality health and fitness app development companies and fitness app developers",
    shareImage: ogpImage,
    article: true,
  };
  return (
      ...
      <div className="main">
        <div className="container">
          <Image
            ...
            src="/images/industries/health-and-fitness-app-development.jpg"
          />
          ...
          <div className="box-media">
            <Animation className="box-media__img">
              <Image
                ...
                loading="eager"
                alt="health & fitness app development"
                src="/images/industries/health-and-fitness-app-development-in-vietnam.jpg"
              />
            </Animation>
            ...
            <div className="back-office__row">
              ...
              <Animation className="back-office__col">
                ...
                <p>
                  ...
                  Software clean the codes, clear the bugs, and ensure the right
                  execution of functionalities before deploying the fitness app.
                </p>
              </Animation>
            </div>
          </div>
          ...
          <div className="box-heavy">
            ...
            <div className="box-heavy__content">
              <Animation className="box-heavy__inner">
                ...
                <p>
                  While fitness web app development addresses your customers on
                  the web, fitness mobile app development helps you to become a
                  part of their everyday part of life.
                </p>
                <p>
                  We, in Relia Software, taking advantage of the experience we
                  have gathered working in various industries, build highly
                  interactive, gamified mobile apps to engage your audience and
                  convert them into your loyal customers.
                </p>
              </Animation>
            </div>
          </div>
          <div className="box-media">
            ...
            <Animation className="box-media__img">
              <Image
                ...
                src="/images/industries/contact-health-and-fitness-app-development.jpg"
                priority={true}
              />
            </Animation>
          </div>
