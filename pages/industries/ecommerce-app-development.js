...
const IndustriesPage = () => {
  const seo = {
    ...
    metaDescription:
      "Looking for an E-commerce Mobile App Development Company? We Provide the best E-commerce mobile app development services for your business. Talk to us now!",
    shareImage: ogpImage,
    article: true,
  };
  return (
      ...
      <div className="main">
        <div className="container">
          <Image
            ...
            src="/images/industries/ecommerce-app-development-for-startup-company.jpg"
            width={1125}
            height={750}
            layout="intrinsic"
            loading="eager"
          ...
          <div className="industries-choose">
            <Animation className="heading">
              <h2 className="hdg-lv2">
                State-of-the-art <span className="text-white">E-commerce</span>{" "}
          ...
          <div className="box-media">
            <Animation className="box-media__img">
              <Image
                alt="Ecommerce app development for startup company"
                src="/images/industries/ecommerce-app-development.jpg"
                width={626}
                height={417}
                layout="intrinsic"
                loading="eager"
            ...
            <div className="back-office__row">
              <Animation className="back-office__col">
                ...
                <p>
                  ...
                  Artificial Intelligence-powered analytics that understands the
                  user behavior and buying patterns. The insights play a crucial
                  role in coming up with recommendations that increase the
                  conversion rate.
                </p>
              </Animation>
              <Animation className="back-office__col">
                ...
                <p>
                  ...
                  Machine Learning-backed analytics can determine what the user
                  wants with their searches, comparisons, and behavior. Our
                  websites and applications assist in tailoring attractive
        ...
        <div className="container">
            ...
            <div className="box-heavy__content">
              <Animation className="box-heavy__inner">
                ...
                <p>
                  ...
                  your users’ homes, E-commerce mobile app development gets your
                  services into the users’ hands.
                </p>
                <p>
                  Mobile apps equip your business with a powerful tool with
                  which you can actively reach out to your customers with
                  personalized recommendations, weekly suggestions, and actively
                  remind them about their wishlist and cart. Further, customer
                  conversion is 140% higher on mobile apps.
                </p>
                <p>
          ...
          <div className="box-media">
            <Animation className="box-media__text">
              ...
              <p>
                ...
                price is lower in mobile apps, there is an increased chance that
                they will choose E-commerce.
              </p>
              <p>
              ...
              <ul className="list-plus">
                ...
                <li>
                  Robust Functionalities Infusing technology with innovation, we
                  build E-commerce apps with a multitude of features and
                  functionalities to improve service and engagement.
                </li>
                <li>
                  Impenetrable Security Relia Software’s E-commerce app
                  developers upgrade themselves with the latest advancements in
                  security to build highly-secured E-commerce applications.
                </li>
              </ul>
            </Animation>
            <Animation className="box-media__img">
              <Image
                alt="Ecommerce app development company in vietnam"
                src="/images/industries/ecommerce-app-development-company-in-vietnam.jpg"
                width={1050}
                height={700}
                layout="intrinsic"
                loading="eager"
          ...
          <div className="list-operations">
            ...
            <Animation className="list-operations__col">
              ...
              <p>
                Be unique to become the trendsetter of the E-commerce industry.
              </p>
              <ul className="list-plus">
