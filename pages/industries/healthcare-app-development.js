...
const IndustriesPage = () => {
  const seo = {
    metaTitle:
      "Healthcare and Medical App Development Company | Healthcare App Developers",
    metaDescription:
      "Top healthcare app development company. Our experienced mHealth app developers provide excellent healthcare app development services for your business.",
    shareImage: ogpImage,
    article: true,
  };
  return (
          ...
          <div className="container">
            ...
            <div className="back-office__row">
              ...
              <Animation className="back-office__col">
                ...
                <p>
                  A breach into a medical data storage system doesn’t just leak
                  sensitive information, but can also result in data
            ...
            <div className="box-heavy__content">
              <Animation className="box-heavy__inner">
                ...
                <p>
                  ...
                  healthcare mobile app development allows you to take advantage
                  of this habit and engage people with better services.
                </p>
                <p>
                  Relia Software’s healthcare mobile app development wing
                  comprises the best healthcare mobile app developers who have
                  worked extensively in the industry and understand the nuances
                  of development to build remarkable mHealth applications.
                </p>
              </Animation>
            </div>
          </div>
            ...
            <Animation className="box-media__text">
              <ul className="list-plus">
                ...
                <li>
                  ...
                  <br />
                  Medical web and mobile applications we build are equipped with
                  prowess required to cut costs and increase app usage.
                </li>
                <li>
          ...
          <div className="list-operations">
            ...
            <Animation className="list-operations__col">
              ...
              <p>
                ...
                well-developed countries, and our Healthcare iOS App development
                would help you to penetrate such regions.
              </p>
            </Animation>
            ...
            <Animation className="list-operations__col">
              ...
              <p>
                With cross-platform frameworks growing every day, cross-platform
                healthcare app development is a viable alternative for native
            ...
            <Animation className="list-operations__col">
              ...
              <p>
                We execute our strategies at maximum seed and build the Minimum
                Viable Product to help our clients to impress the investors and
                attract users.
              </p>
            </Animation>
            ...
            <Animation className="list-operations__col">
              ...
              <p>
                Our medical web app development empowers businesses to dominate
                the online space with superior performances.
              </p>
            </Animation>
            <Animation className="list-operations__col">
              <Image
            ...
            <Animation className="list-operations__col">
              ...
              <p>
                ...
                to endow you with the applications capable of turning the tides.
              </p>
            </Animation>
          </div>
          <div className="box-media">
            ...
            <Animation className="box-media__text">
              ...
              <p>
                We are a healthcare web and mobile app development company with
                a sound portfolio and we might be who you are looking for. Get
                in touch with us; we are just a mail away.
              </p>
              <p>
