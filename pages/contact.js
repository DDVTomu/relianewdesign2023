        ...
        <div className="container">
          <div className="contact-box">
            <Animation className="contact-box-col">
              <Image alt="icon pin" src="/images/icon/icon-pin.svg" width={42} height={52} layout="intrinsic" loading="eager" />
              <h3>Our Location</h3>
              <p>
            ...
            <Animation className="contact-box-col">
              <Image alt="icon email" src="/images/icon/icon-email.svg" width={52} height={38} layout="intrinsic" loading="eager" />
              <h3>Email & Phone</h3>
              <p>
            ...
            <Animation className="contact-box-col">
              <Image alt="icon like" src="/images/icon/icon-like.svg" width={46} height={46} layout="intrinsic" loading="eager" />
              <h3>Get In Touch</h3>
