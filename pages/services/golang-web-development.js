        ...
        <div className="container">
          ...
          <div className="box-media">
            <Animation className="box-media__img">
              <Image alt="golang development 01" src="/images/services/golang-development-01.jpg" width={336} height={216} layout="intrinsic" loading="eager" />
            </Animation>
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__img">
              <Image alt="golang development" src="/images/services/golang-development.jpg" width={557} height={313} layout="intrinsic" loading="eager" />
            </Animation>
          </div>
        </div>
            ...
            <div className="list-chain">
              <Animation className="item">
                <div className="item__thumb">
                  <Image alt="benefits of using golang 01" src="/images/services/benefits-of-using-golang-01.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
                </div>
              ...
              <Animation className="item">
                <div className="item__thumb">
                  <Image alt="benefits of using golang 02" src="/images/services/benefits-of-using-golang-02.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
                </div>
                <div className="item__content">
              ...
              <Animation className="item">
                <div className="item__thumb">
                  <Image alt="benefits of using golang 03" src="/images/services/benefits-of-using-golang-03.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
                </div>
                <div className="item__content">
              ...
              <Animation className="item">
                <div className="item__thumb">
                  <Image alt="benefits of using golang 04" src="/images/services/benefits-of-using-golang-04.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
                </div>
                <div className="item__content">
              ...
              <Animation className="item">
                <div className="item__thumb">
                  <Image alt="benefits of using golang 05" src="/images/services/benefits-of-using-golang-05.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
                </div>
                <div className="item__content">
