...
const NodeJs = () => {
  const seo = {
    metaTitle: "NodeJS Development company | Relia Software",
          ...
          <div className="container">
            ...
            <div className="ieo-services">
              <Animation className="ieo-services__col">
                <Image alt="nodejs development company 01" src="/images/services/nodejs-development-company-01.jpg" width={600} height={500} layout="intrinsic" loading="eager" />
              </Animation>
        ...
        <div className="container">
          ...
          <div className="box-reasons" style={{ marginBottom: 0 }}>
            <Animation className="box-reasons__col">
              <Image
                alt="nodejs development company 02"
          ...
          <div className="box-reasons">
            ...
            <Animation className="box-reasons__col">
              <Image
                alt="nodejs development company 03"
        ...
        <div className="box-contact">
          <div className="container">
            ...
            <Animation className="box-contact__img">
              <Image alt="nodejs contact" src="/images/services/nodejs-contact.png" width={342} height={209} layout="intrinsic" loading="eager" />
            </Animation>
            <Link href="/contact">
