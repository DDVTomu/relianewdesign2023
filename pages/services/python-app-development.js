...
const PythonApp = () => {
  const seo = {
    metaTitle: "Python App Development Company | Relia Software",
        ...
        <div className="container">
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__img">
              <Image alt="python app development" src="/images/services/python-app-development.jpg" width={439} height={329} layout="intrinsic" loading="eager" />
            </Animation>
          </div>
          <div className="app-service">
            <Animation className="app-service-col">
              <Image alt="python app development 01" src="/images/services/python-app-development-01.png" width={520} height={268} layout="intrinsic" loading="eager" />
            </Animation>
          ...
          <div className="box-reasons">
            ...
            <Animation className="box-reasons__col">
              <Image alt="python app development 02" src="/images/services/python-app-development-02.jpg" width={401} height={389} layout="intrinsic" loading="eager" />
            </Animation>
          </div>
        </div>
        <div className="container">
          ...
          <div className="container">
            ...
            <div className="ieo-services">
              ...
              <Animation className="ieo-services__col">
                <Image alt="python app development 03" src="/images/services/python-app-development-03.jpg" width={601} height={421} layout="intrinsic" loading="eager" />
              </Animation>
            </div>
