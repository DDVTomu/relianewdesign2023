        ...
        <div className="container">
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__img">
              <Image alt="react native app development" src="/images/services/react-native-app-development.jpg" width={750} height={422} layout="intrinsic" loading="eager" />
            </Animation>
          </div>
        </div>
        <div className="container">
          ...
          <div className="box-media">
            <Animation className="box-media__img">
              <Image alt="react native app development 01" src="/images/services/react-native-app-development-01.jpg" width={749} height={349} layout="intrinsic" loading="eager" />
            </Animation>
            <Animation className="box-media__text">
              <p>
        ...
        <div className="box-contact">
          <div className="container">
            ...
            <Animation className="box-contact__img">
              <Image
                alt="learn more about our range of mobile app"
