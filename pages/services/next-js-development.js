        ...
        <div className="container">
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__img">
              <Image alt="nextjs development company 01" src="/images/services/nextjs-development-company-01.jpg" width={368} height={221} layout="intrinsic" loading="eager" />
            </Animation>
          </div>
          <div className="box-media">
            <Animation className="box-media__img">
              <Image alt="nextjs development company 02" src="/images/services/nextjs-development-company-02.jpg" width={455} height={408} layout="intrinsic" loading="eager" />
            </Animation>
            <Animation className="box-media__text">
              <p>
          ...
          <div className="list-chain">
            <Animation className="item">
              <div className="item__thumb">
                <Image alt="nextjs development 01" src="/images/services/nextjs-development-01.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
              </div>
            ...
            <Animation className="item">
              <div className="item__thumb">
                <Image alt="nextjs development 02" src="/images/services/nextjs-development-02.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
              </div>
              <div className="item__content">
            ...
            <Animation className="item">
              <div className="item__thumb">
                <Image alt="nextjs development 03" src="/images/services/nextjs-development-03.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
              </div>
              <div className="item__content">
            ...
            <Animation className="item">
              <div className="item__thumb">
                <Image alt="nextjs development 04" src="/images/services/nextjs-development-04.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
              </div>
              <div className="item__content">
            ...
            <Animation className="item">
              <div className="item__thumb">
                <Image alt="nextjs development 05" src="/images/services/nextjs-development-05.jpg" width={360} height={90} layout="intrinsic" loading="eager" />
              </div>
              <div className="item__content">
          ...
          <div className="container">
            ...
            <Animation>
              <div className="box-contact__img" style={{ maxWidth: "252px" }}>
                <Image
                  alt="nextjs development company 01"
