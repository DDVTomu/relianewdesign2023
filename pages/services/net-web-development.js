      ...
      <div className="main">
        <div className="container">
          ...
          <div className="box-media">
            ...
            <Animation className="box-media__img">
              <Image alt="net web development 01" src="/images/services/net-web-development-01.jpg" width={328} height={370} layout="intrinsic" loading="eager" />
        ...
        <div className="container">
          ...
          <div className="box-reasons">
            <Animation className="box-reasons__col">
              <Image alt="net web development 02" src="/images/services/net-web-development-02.jpg" width={431} height={347} layout="intrinsic" loading="eager" />
            </Animation>
            <Animation className="box-reasons__col">
              <ul className="list-arrow">
                <li>
