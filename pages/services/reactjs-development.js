      ...
      <div className="main">
        ...
        <div className="container">
          ...
          <div className="box-reasons">
            ...
            <Animation className="box-reasons__col">
              <Image
                alt="relia software for your react requirements 02"
          ...
          <div className="box-media">
            <Animation className="box-media__img">
              <Image alt="flutter app development" src="/images/services/flutter-app-development.png" width={1290} height={806} layout="intrinsic" loading="eager" />
            </Animation>
            <Animation className="box-media__text">
